/** Offline UI QA; copied workspace and SQL-derived synthetic HTTP fixtures only. */
...
export default defineConfig({
  testDir: ".",
  testMatch: "source-task-operations.visual.ts",
  outputDir: mkdtempSync(path.join(tmpdir(), "sclib-source-task-browser-artifacts-")),
  fullyParallel: false,
  workers: 1,
  retries: 0,
  timeout: 45_000,
  ...
  webServer: {
    ...
    url: `${baseURL}/dashboard/research/source-tasks`,
