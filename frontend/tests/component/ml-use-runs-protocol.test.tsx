...
describe("native run protocol — original SQL/HTTP bytes", () => {
  it("pins all 612 source inputs including evidence intake, historical bytes, and 28 original response strings", () => {
    expect(sha(readFileSync(resolve(process.cwd(), "tests/fixtures/ml-use-runs-native.delivery20260922r7.wire.json")))).toBe("ef699550a132ffbe20013405b38a5ac7b2852a616997e6312ff260942dd32a79");
