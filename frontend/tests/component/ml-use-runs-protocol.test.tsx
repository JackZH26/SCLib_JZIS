...
describe("native run protocol — original SQL/HTTP bytes", () => {
  it("pins all 612 source inputs including evidence intake, historical bytes, and 28 original response strings", () => {
    expect(sha(readFileSync(resolve(process.cwd(), "tests/fixtures/ml-use-runs-native.delivery20260922r6.wire.json")))).toBe("e25f3a0753d89056ac38df92984bea7bb9074289a1db3e331e8c9d27bceab68d");
