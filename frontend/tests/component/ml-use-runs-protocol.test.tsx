...
describe("native run protocol — original SQL/HTTP bytes", () => {
  it("pins all 593 source inputs including evidence intake, historical bytes, and 28 original response strings", () => {
    expect(sha(readFileSync(resolve(process.cwd(), "tests/fixtures/ml-use-runs-native.delivery20260915r2.wire.json")))).toBe("ce1f8796f23cb5aa143e21b1ba208bcbc1517c6450962ee69b1c3bccc20ae91b");
