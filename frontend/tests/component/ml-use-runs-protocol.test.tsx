...
describe("native run protocol — original SQL/HTTP bytes", () => {
  it("pins all 598 source inputs including evidence intake, historical bytes, and 28 original response strings", () => {
    expect(sha(readFileSync(resolve(process.cwd(), "tests/fixtures/ml-use-runs-native.delivery20260921r2.wire.json")))).toBe("776914eeeb6b072e6025be7c4c27a6b0d243fc94da150be7b74dc8c3c518d4ee");
