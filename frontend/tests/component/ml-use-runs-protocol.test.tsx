...
describe("native run protocol — original SQL/HTTP bytes", () => {
  it("pins all 598 source inputs including evidence intake, historical bytes, and 28 original response strings", () => {
    expect(sha(readFileSync(resolve(process.cwd(), "tests/fixtures/ml-use-runs-native.delivery20260921r7.wire.json")))).toBe("6a594c8fd4c15ab7d0b58041cb44982c31bfeddf8d1fcdade53a351b32162440");
