...
describe("native run protocol — original SQL/HTTP bytes", () => {
  it("pins all 612 source inputs including evidence intake, historical bytes, and 28 original response strings", () => {
    expect(sha(readFileSync(resolve(process.cwd(), "tests/fixtures/ml-use-runs-native.delivery20260922r8.wire.json")))).toBe("fa6209488a69ece32705cc7812c5f0b343a3aefaab91515126ca547ce3548a4e");
