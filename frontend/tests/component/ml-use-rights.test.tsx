...
import http from "../fixtures/ml-use-rights-native.delivery20260921r5.wire.json";
...
describe("actual native ML rights protocol", () => {
  it("pins the exact native archive and all 598 backend/harness/schema source files", () => {
    ...
    expect(hash(readFileSync(resolve(process.cwd(), "tests/fixtures/ml-use-rights-native.delivery20260921r5.wire.json")))).toBe("6b866e6ac98a515b26fa8ded6d2d2c42ab44dc9baf3bff79a0ae13e8f57a26d4");
