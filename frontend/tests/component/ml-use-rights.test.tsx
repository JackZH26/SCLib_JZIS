...
import http from "../fixtures/ml-use-rights-native.delivery20260921r4.wire.json";
...
describe("actual native ML rights protocol", () => {
  it("pins the exact native archive and all 598 backend/harness/schema source files", () => {
    ...
    expect(hash(readFileSync(resolve(process.cwd(), "tests/fixtures/ml-use-rights-native.delivery20260921r4.wire.json")))).toBe("e76efc631b47cbe49f50ab41fc7dd0c16c6a2c2e9ae7941b7fd77cef822dda93");
