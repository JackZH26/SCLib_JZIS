...
import http from "../fixtures/ml-use-rights-native.delivery20260922r6.wire.json";
...
describe("actual native ML rights protocol", () => {
  it("pins the exact native archive and all 612 backend/harness/schema source files", () => {
    ...
    expect(hash(readFileSync(resolve(process.cwd(), "tests/fixtures/ml-use-rights-native.delivery20260922r6.wire.json")))).toBe("19ef5b96656db9b2951d7da906a8c83652a00ed795b22ea00644b475e578c91b");
