...
import http from "../fixtures/ml-use-rights-native.delivery20260922r3.wire.json";
...
describe("actual native ML rights protocol", () => {
  it("pins the exact native archive and all 600 backend/harness/schema source files", () => {
    const hash = (b: Buffer) => createHash("sha256").update(b).digest("hex");
    expect(hash(readFileSync(resolve(process.cwd(), "tests/fixtures/ml-use-rights-native.delivery20260922r3.wire.json")))).toBe("0c9e9fe7540f7ad6c5fd5f08d21ab800af3b73c7c24f6d74bb694fecd453e092");
