...
import http from "../fixtures/ml-use-rights-native.delivery20260921r7.wire.json";
...
describe("actual native ML rights protocol", () => {
  it("pins the exact native archive and all 598 backend/harness/schema source files", () => {
    ...
    expect(hash(readFileSync(resolve(process.cwd(), "tests/fixtures/ml-use-rights-native.delivery20260921r7.wire.json")))).toBe("a1811dfc4ac929d50213bcfc99cfd0597266175811ea33ba2d134bfbbcbefc79");
