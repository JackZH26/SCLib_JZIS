...
import http from "../fixtures/ml-use-rights-native.delivery20260921r3.wire.json";
...
describe("actual native ML rights protocol", () => {
  it("pins the exact native archive and all 598 backend/harness/schema source files", () => {
    ...
    expect(hash(readFileSync(resolve(process.cwd(), "tests/fixtures/ml-use-rights-native.delivery20260921r3.wire.json")))).toBe("bed6f895828d359709a515b9d8d24354baa7cd530bc7abaa6fbc3570d07810c0");
