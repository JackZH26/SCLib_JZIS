...
import http from "../fixtures/ml-use-rights-native.delivery20260922r2.wire.json";
...
describe("actual native ML rights protocol", () => {
  it("pins the exact native archive and all 598 backend/harness/schema source files", () => {
    ...
    expect(hash(readFileSync(resolve(process.cwd(), "tests/fixtures/ml-use-rights-native.delivery20260922r2.wire.json")))).toBe("19c3fd7849f57337ea567019ad50448cc306e53e8ebfe77583fe93f005ef456c");
