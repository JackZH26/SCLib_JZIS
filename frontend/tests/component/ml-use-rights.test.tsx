...
import http from "../fixtures/ml-use-rights-native.delivery20260922r5.wire.json";
...
describe("actual native ML rights protocol", () => {
  it("pins the exact native archive and all 612 backend/harness/schema source files", () => {
    const hash = (b: Buffer) => createHash("sha256").update(b).digest("hex");
    expect(hash(readFileSync(resolve(process.cwd(), "tests/fixtures/ml-use-rights-native.delivery20260922r5.wire.json")))).toBe("86678fdf7f5212c7e24390cb7b05a97f9828267dbe028b23fbe7317ced6c8393");
