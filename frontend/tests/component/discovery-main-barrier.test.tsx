...
import nativeWire from "../fixtures/discovery-main-barrier-native.delivery20260921r3.wire.json";
...
describe("actual guarded native v2 wire compatibility", () => {
  it("pins the retained capture and the backend inputs used by this batch", () => {
    expect(hash(readFileSync(resolve(process.cwd(), "tests/fixtures/discovery-main-barrier-native.delivery20260921r3.wire.json"), "utf8")))
      .toBe("18f85b0c405750d74bdd97b83dbb1844baefea2fb81e09b54771f56c12032bfc");
