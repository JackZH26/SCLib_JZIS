...
import nativeWire from "../fixtures/discovery-main-barrier-native.delivery20260921r2.wire.json";
...
describe("actual guarded native v2 wire compatibility", () => {
  it("pins the retained capture and the backend inputs used by this batch", () => {
    expect(hash(readFileSync(resolve(process.cwd(), "tests/fixtures/discovery-main-barrier-native.delivery20260921r2.wire.json"), "utf8")))
      .toBe("c9decc35b341f5d07d46911d7c1a0705f9b7876be3828ef1803a3b5f7df7dc18");
