...
import nativeWire from "../fixtures/discovery-main-barrier-native.delivery20260922r2.wire.json";
...
describe("actual guarded native v2 wire compatibility", () => {
  it("pins the retained capture and the backend inputs used by this batch", () => {
    expect(hash(readFileSync(resolve(process.cwd(), "tests/fixtures/discovery-main-barrier-native.delivery20260922r2.wire.json"), "utf8")))
      .toBe("aa72941979ee2418c81c61efdb88105a59316d2a37800219ee9d8d2c275a1596");
