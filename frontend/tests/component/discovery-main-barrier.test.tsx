...
import nativeWire from "../fixtures/discovery-main-barrier-native.delivery20260921r7.wire.json";
...
describe("actual guarded native v2 wire compatibility", () => {
  it("pins the retained capture and the backend inputs used by this batch", () => {
    expect(hash(readFileSync(resolve(process.cwd(), "tests/fixtures/discovery-main-barrier-native.delivery20260921r7.wire.json"), "utf8")))
      .toBe("2751d0a14db797264bf750535f3da7857721884cabb08d1ca24c533943b76888");
