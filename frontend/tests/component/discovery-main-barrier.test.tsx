...
import nativeWire from "../fixtures/discovery-main-barrier-native.delivery20260923r3.wire.json";
...
describe("actual guarded native v2 wire compatibility", () => {
  it("pins the retained capture and the backend inputs used by this batch", () => {
    expect(hash(readFileSync(resolve(process.cwd(), "tests/fixtures/discovery-main-barrier-native.delivery20260923r3.wire.json"), "utf8")))
      .toBe("70067895c31098b529e218eef2a7dfefc566416977e7ad0340596d2456c5b63e");
