...
describe("actual native canary byte inspection", () => {
  ...
  it("retains unmodified native replies and exact selected source pins", () => {
    expect(sha(readFileSync(resolve(process.cwd(), "tests/fixtures/ml-pilot-evidence-native.delivery20260921r9.wire.json")))).toBe("fdde96cbe5db6a3532ba31a146a83563bee7d6067e69f07975591380ae2317de");
