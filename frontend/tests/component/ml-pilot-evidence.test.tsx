...
describe("actual native canary byte inspection", () => {
  ...
  it("retains unmodified native replies and exact selected source pins", () => {
    expect(sha(readFileSync(resolve(process.cwd(), "tests/fixtures/ml-pilot-evidence-native.delivery20260922r7.wire.json")))).toBe("57bee36e90b15d8ea058f3d3d0d528489fde4453f6e2101197deed13bbd8bae3");
