...
describe("native own-review declaration protocol", () => {
  ...
  it("pins current original replies without resealing historical evidence", () => {
    expect(sha(readFileSync(resolve(process.cwd(), "tests/fixtures/ml-pilot-attestations-native.delivery20260921r8.wire.json")))).toBe("2138fd0670b618734b2cc9f0d9bef10ba48dfd91cd093477ecc608773144c378");
