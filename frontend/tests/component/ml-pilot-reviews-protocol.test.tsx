...
describe("native own-review declaration protocol", () => {
  ...
  it("pins current original replies without resealing historical evidence", () => {
    expect(sha(readFileSync(resolve(process.cwd(), "tests/fixtures/ml-pilot-attestations-native.delivery20260922r8.wire.json")))).toBe("da49038e156b9c2a5e1ee03c49e0ff1996136eebd53d23086b8a79f33e346060");
