...
describe("native own-review declaration protocol", () => {
  ...
  it("pins current original replies without resealing historical evidence", () => {
    expect(sha(readFileSync(resolve(process.cwd(), "tests/fixtures/ml-pilot-attestations-native.delivery20260922r5.wire.json")))).toBe("62aa1220de0b0a90d270aa5aa460ca91c18d73c48898dba276d81402c53a6f9b");
    ...
    expect(native.source_pins).toHaveLength(612);
    expect(new Set(native.source_pins.map(p => p.path)).size).toBe(612);
