...
describe("native own-review declaration protocol", () => {
  ...
  it("pins current original replies without resealing historical evidence", () => {
    expect(sha(readFileSync(resolve(process.cwd(), "tests/fixtures/ml-pilot-attestations-native.delivery20260922r3.wire.json")))).toBe("a9ffe5a90c1d47f8fda2a0cacd3d811a4e32cee309767f5d5e2a8772ed3befda");
    ...
    expect(native.source_pins).toHaveLength(600);
    expect(new Set(native.source_pins.map(p => p.path)).size).toBe(600);
