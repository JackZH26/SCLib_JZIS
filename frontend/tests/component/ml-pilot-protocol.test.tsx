...
describe("original native pilot participation protocol", () => {
  it("pins the capture, original replies and each current source without resealing old evidence", () => {
    expect(sha(readFileSync(resolve(process.cwd(), "tests/fixtures/ml-pilot-participant-native.delivery20260921r8.wire.json")))).toBe("9aff4d67216016a0606d28c4c374a624a2123200b41726bc4188103eebeb0e93");
