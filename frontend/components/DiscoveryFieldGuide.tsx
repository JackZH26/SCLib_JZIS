...
export function DiscoveryFieldGuide() {
  ...
  return <details className="rounded-lg border border-sage-border bg-white p-4 text-sm">
    ...
    <p className="mt-2 text-xs leading-5 text-sage-muted">The live scientific matrix uses eight native rv2/1 properties with their own keys and units. This broader planned dictionary is not its database schema: native DOS is dos_at_fermi (states/eV/formula_unit), and native superfluid_stiffness is in K. Draft fields or units must not be substituted into live results.</p>
