"""Packaged ML08 documentary accounting. No network, database or approval.
...
SCHEMA_PATH = Path(__file__).with_name("ml08_pilot.schema.json")
...
def validate(selection: dict, reviews: list[dict], conclusion: dict | None = None,
    ...
    report = {"schema_version": "ml08-accounting/1.0.0", "scientific_acceptance": False,
              "status": "invalid", "errors": errors, "warnings": list(WARNINGS),
