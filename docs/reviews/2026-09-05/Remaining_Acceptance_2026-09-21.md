...
| --- | --- | --- | --- |
| 1 | Deliver the verified engineering branch; EN01/EN02/EN03/EN04/DR03 | Complete Linux Test/Security for the submitted PR #80; map each bounded engineering criterion to delivered evidence | The September 15 baseline is verified. RG04/0078, including stale-source withdrawal and scoped recovery verification, passes focused API, offline, migration, restore and complete frontend checks; recaptured browser validation passes; complete API validation passes 7,460 cases across all 224 modules, with the three opt-in reference skips separately rerun and passed. GitHub authorization is complete and PR #80 is submitted; remote CI findings and production rehearsal progress are tracked in `Remote_Release_2026-09-21.md`. Human pilot completion is not imposed on bounded engineering issue closure. |
...
| 7 | Operational release / EN04 / EN06 | Exact Linux/image inventory evidence, production-specific backup/restore and role/IAM checks, approved migration/read cutover and rollback evidence, monitoring acceptance | Actual production backup restore and the 0043-to-0078 clone rehearsal passed; original retained relation fingerprints match. Separate production database roles and real credential authentication passed. Public cutover remains blocked by the unconverted full-corpus ANN index (new Similar returns 503), the 33.5-second material-list scan, SLO/freshness admission, and approved alert delivery. Preserve the explicit ingestion pause until its resumption is confirmed. Details and exact receipts are in `Remote_Release_2026-09-21.md`. |
...
The user subsequently authorized PR submission, technically ready merge and
production deployment/acceptance, excluding human scientific review. That
