...
- [ML review companion next-slice design — 2026-09-08](ML_Review_Companion_Implementation_Design_2026-09-08.md): proposed independently pinned review overlay and new negative-only compiler; exact feature exclusions, fair rebuilt cohorts and honest native-import ineligibility. Proposal only, not implemented.
